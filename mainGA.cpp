...
// Valid Genes (ASCII)
const string GENES = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 1234567890, .-;:_!\"#%&/()=?@${[]}"; //86
...
int main()
{
	...
	for(int i = 0;i<POPULATION_SIZE;i++)
	{
		...
		population.push_back(Individual(gnome)); //push_back: Adds a new element at the end of the list container, after its current last element.
	}
